...
mareh_image2 = face_recognition.load_image_file('images/samples/mareh.jpg')
mareh_face_encodings2 = face_recognition.face_encodings(mareh_image2)[0]


#save encodings and corresponding labels in separeate arrays in same order
known_face_encodings = [modi_face_encodings, trump_face_encodings, mareh_face_encodings, mareh_face_encodings2]
known_face_names = ["Naredra Modi", "Donald Trump","Wilfred Marete", "Wilfred Marete"]
